...
const monthValues = {
  narrow: ["ມ.ຄ.", "ກ.ພ.", "ມີ.ຄ.", "ເມ.ຍ.", "ພ.ຄ.", "ມິ.ຍ.", "ກ.ລ.", "ສ.ຫ.", "ກ.ຍ.", "ຕ.ລ.", "ພ.ຈ.", "ທ.ວ."],
  abbreviated: ["ມັງກອນ", "ກຸມພາ", "ມີນາ", "ເມສາ", "ພຶດສະພາ", "ມິຖຸນາ", "ກໍລະກົດ", "ສິງຫາ", "ກັນຍາ", "ຕຸລາ", "ພະຈິກ", "ທັນວາ"],
  wide: ["ມັງກອນ", "ກຸມພາ", "ມີນາ", "ເມສາ", "ພຶດສະພາ", "ມິຖຸນา", "ກໍລະກົດ", "ສິງຫາ", "ກັນຍາ", "ຕຸລາ", "ພະຈິກ", "ທັນວາ"],
};

const dayValues = {
  narrow: ["ທິດ", "ຈັນ", "ຄານ", "ພຸດ", "ພະ", "ສຸກ", "ເສົາ"],
  short: ["ທິດ", "ຈັນ", "ຄาน", "ພຸດ", "ພະ", "ສຸກ", "ເສົາ"],
